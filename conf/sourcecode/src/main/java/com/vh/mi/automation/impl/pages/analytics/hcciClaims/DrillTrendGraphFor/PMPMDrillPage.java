...
import com.vh.mi.automation.api.pages.analytics.claims.Drill.IPMPMDrillPage;
 ...
 */
public class PMPMDrillPage extends AbstractDrillPage implements IPMPMDrillPage{
    private WebElements webElements;

    public PMPMDrillPage(WebDriver webDriver){
        super(webDriver);
