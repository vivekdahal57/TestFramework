 ...
 */
public enum RxClassDrillPageColumns  implements IDataGridColumn{
    CLAIM_TYPE("CLMTYPEDESC" , "Claim Type" , DataType.STRING),
    RX_CLASS_CODE("DIMID" , " RxGroup Class Code" , DataType.INTEGER),
    RX_CLASS("DIMDESC" , "RxGroup Class" , DataType.STRING),
    ...
    private static Logger logger = LoggerFactory.getLogger(RxClassDrillPageColumns.class);
    private String id;
    private String label;
    private DataType dataType;

    private RxClassDrillPageColumns(String id, String label, DataType dataType){
        this.id = id;
        this.label = label;
    ...
    public static IDataGridColumn fromId(String id){
        for(RxClassDrillPageColumns c : RxClassDrillPageColumns.values()){
