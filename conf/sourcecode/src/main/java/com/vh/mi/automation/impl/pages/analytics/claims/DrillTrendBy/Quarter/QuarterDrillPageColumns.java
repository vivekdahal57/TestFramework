package com.vh.mi.automation.impl.pages.analytics.claims.DrillTrendBy.Quarter;
 ...
 */
public enum QuarterDrillPageColumns implements IDataGridColumn {
    ...
    private static Logger logger = LoggerFactory.getLogger(QuarterDrillPageColumns.class);
    private String id;
    private String label;
    private DataType dataType;

    private QuarterDrillPageColumns(String id, String label, DataType dataType){
        this.id = id;
        this.label = label;
    ...
    public static IDataGridColumn fromId(String id){
        for(QuarterDrillPageColumns c : QuarterDrillPageColumns.values()){
