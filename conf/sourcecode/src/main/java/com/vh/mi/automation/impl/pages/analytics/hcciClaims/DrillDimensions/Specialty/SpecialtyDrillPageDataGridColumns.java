 ...
 */
public enum SpecialtyDrillPageDataGridColumns implements IDataGridColumn {
    CLAIM_TYPE("CLMTYPEDESC" , "Claim Type" , DataType.STRING),
    SPECIALTY("DIMDESC" , "Specialty" , DataType.STRING),
  ...
  ;
    ...
    private static Logger logger = LoggerFactory.getLogger(SpecialtyDrillPageDataGridColumns.class);
    private String id;
    private String label;
    private DataType dataType;

    private SpecialtyDrillPageDataGridColumns(String id, String label, DataType dataType){
        this.id = id;
        this.label = label;
    ...
    public static IDataGridColumn fromId(String id){
        for(SpecialtyDrillPageDataGridColumns c : SpecialtyDrillPageDataGridColumns.values()){
