 ...
 */
public class HcciServicesDrillPage extends AbstractDrillPage implements HcciIClaims01DrillPage,IHaveAnalysisPeriod,IHaveReportingBy {
    private static final String JOBNAME = "CSV_JOBNAME_" + Random.getRandomStringOfLength(3);
    private HcciServicesDataGrid dataGrid;
    ...
    public HcciServicesDrillPage(WebDriver webDriver){
        super(webDriver);
        dataGrid = new HcciServicesDataGrid(getDriver());
    ...
    public IDataGridCustomizer getDataGridCustomizerServices(){
        ...
        return new DataGridCustomizer(getDriver(), new IColumnSpec() {
            ...
            public IDataGridColumn getColumnByLabel(String colName) {
                return HcciClaims01ServicesDataGridColumn.fromLabel(colName);
            }
        });
    }
