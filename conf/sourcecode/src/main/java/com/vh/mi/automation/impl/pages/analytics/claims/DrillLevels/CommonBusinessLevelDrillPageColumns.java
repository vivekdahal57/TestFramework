 ...
 */
public enum CommonBusinessLevelDrillPageColumns implements IDataGridColumn{
    //Plan type is taken as one of the business levels
    PLAN_TYPE("DIMDESC" , "Plan Type" , DataType.STRING),
   ...
   ;
    private static Logger logger = LoggerFactory.getLogger(CommonBusinessLevelDrillPageColumns.class);
    private String id;
    private String label;
    private DataType dataType;

    private CommonBusinessLevelDrillPageColumns(String id, String label, DataType dataType){
        this. id = id;
        this.label = label;
    ...
    public static IDataGridColumn fromId(String id){
        for(CommonBusinessLevelDrillPageColumns c : CommonBusinessLevelDrillPageColumns.values()){
