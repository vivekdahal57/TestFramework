package com.vh.mi.automation.impl.pages.queryBuilder.claimsSearch.provider;


import com.vh.mi.automation.api.pages.queryBuilder.claimsSearch.Provider.IProvider;
 ...
 */
public class ProviderGroup extends QueryBuilderToolBar implements IProvider{
    private static final String NTH_CHECKBOX_PLACEHOLDER = "${nthCheckbox}";
     WebElements webElements;


    public ProviderGroup(WebDriver webDriver){
        super(webDriver);
