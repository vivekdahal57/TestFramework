package com.vh.mi.automation.impl.pages.analytics.claims.DrillTrendBy.DrillMonth;
 ...
 */
public enum MonthDrillPageColumns implements IDataGridColumn {
    ...
    private static Logger logger = LoggerFactory.getLogger(MonthDrillPageColumns.class);
    private String id;
    private String label;
    private DataType dataType;

    private MonthDrillPageColumns(String id, String label, DataType dataType){
        this.id = id;
        this.label = label;
    ...
    public static IDataGridColumn fromId(String id){
        for(MonthDrillPageColumns c : MonthDrillPageColumns.values()){
