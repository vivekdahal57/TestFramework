 ...
 */
public enum Claims01DrillPageDataGridColumns implements IDataGridColumn {
...
;
    ...
    private Claims01DrillPageDataGridColumns(String id, String label, DataType dataType){
        this.id = id;
        this.label = label;
    ...
    public static IDataGridColumn fromId(String id){
        for(Claims01DrillPageDataGridColumns c : Claims01DrillPageDataGridColumns.values()){
