package com.vh.mi.automation.impl.pages.queryBuilder.claimsSearch.Rx;

import com.vh.mi.automation.api.pages.queryBuilder.claimsSearch.Rx.IRx;
 ...
 */
public class RxGroup extends QueryBuilderToolBar implements IRx{
    private static final String NTH_CHECKBOX_PLACEHOLDER = "${nthCheckbox}";
    WebElements  webElements;

    public RxGroup(WebDriver webDriver){
        super(webDriver);
    ...
    private void selectNthCheckbox(String nthCheckbox){
        String xpath = "(//*[@id='d2Form:simpleGridAll']//td/input[@type='checkbox'])[${nthCheckbox}]";
