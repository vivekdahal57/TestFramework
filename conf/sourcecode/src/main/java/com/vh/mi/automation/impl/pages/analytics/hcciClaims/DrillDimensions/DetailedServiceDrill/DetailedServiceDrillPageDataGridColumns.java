 ...
 */
public enum DetailedServiceDrillPageDataGridColumns implements IDataGridColumn {
    CLAIM_TYPE("CLMTYPEDESC" , "Claim Type" , DataType.STRING),
    DETAILED_SERVICE_CATEGORY("DIMDESC" ,"Detailed Service" , DataType.STRING),
    ...
    private static Logger logger = LoggerFactory.getLogger(DetailedServiceDrillPageDataGridColumns.class);
    private String id;
    private String label;
    private DataType dataType;

    private DetailedServiceDrillPageDataGridColumns(String id, String label, DataType dataType){
        this.id = id;
        this.label = label;
    ...
    public static IDataGridColumn fromId(String id){
        for(DetailedServiceDrillPageDataGridColumns c : DetailedServiceDrillPageDataGridColumns.values()){
