 ...
 */
public enum SubDetailedServiceDrillPageDataGridColumns implements IDataGridColumn {
    CLAIM_TYPE("CLMTYPEDESC" , "Claim Type" , DataType.STRING),
    SUB_DETAILED_SERVICE_CATEGORY("DIMDESC" ,"Detailed Service" , DataType.STRING),
    ...
    private static Logger logger = LoggerFactory.getLogger(SubDetailedServiceDrillPageDataGridColumns.class);
    private String id;
    private String label;
    private DataType dataType;

    private SubDetailedServiceDrillPageDataGridColumns(String id, String label, DataType dataType){
        this.id = id;
        this.label = label;
    ...
    public static IDataGridColumn fromId(String id){
        for(SubDetailedServiceDrillPageDataGridColumns c : SubDetailedServiceDrillPageDataGridColumns.values()){
