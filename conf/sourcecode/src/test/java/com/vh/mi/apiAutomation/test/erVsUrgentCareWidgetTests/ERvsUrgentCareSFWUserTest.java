 ...
 */
public class ERvsUrgentCareSFWUserTest extends AbstractDeveloperPageAction {
    final String REQUEST_URL =
            APIGATEWAY_URL + "/ervisit/erVsUrgentCare/bucketed";
    static String JSON_SCHEMA_PATH = "schema/erVsUrgentCare.json";
    static String ticket = "";
    static String dataURL = "/api/ervisit/erVsUrgentCare";
    static String memberQueryFileName = "erVsUrgentCareQuerySFW.sql";
    ...
    public void verifyWidgetCallWithAllCorrectLvlValues() {
        String[][] blParam = { { "ABC" }, { "Blumfield IPA" },
                ...
                { "BERGE, ERLAND MD" }, {}, {} };
        JsonBuilder payLoad = new PayloadCreator()
                .erVsUrgentCareWidgetPayLoad(blParam, FULL_CYCLE, INCURRED_DATE,
                        COST, null);
        ticket = getTokenForRequestedURL(REQUEST_URL);
        logger.info("Request Sent: \n" + payLoad.toPrettyString());
        Response res = given().contentType("application/json")
    ...
    public void verifyWidgetCallWithCorrectBusinessLvlValuesButWrongAP() {
        ...
        JsonBuilder payLoad = new PayloadCreator()
                .erVsUrgentCareWidgetPayLoad(blParam, FULL_CYCLE, WRONG_AP,
                        COST, null);
        ticket = getTokenForRequestedURL(REQUEST_URL);
        logger.info("Request Sent: \n" + payLoad.toPrettyString());
        Response res = given().contentType("application/json")
    ...
    public void verifyWidgetCallWithWidgetPayloadToGetMemberQuery() {
        ...
        String memberQueryPayLoad = new PayloadCreator()
                .erVsUrgentCareWidgetMemberQueryPayload(payLoad, dataURL,
                        "ER_VS_URGENT_CARE", "IP ER", "201501")
                .toPrettyString();
        ticket = getTokenForRequestedURL(
                REQUEST_URL.replace("/bucketed", "") + "/memberQuery");
        logger.info("Request Sent: \n" + memberQueryPayLoad);
        Response res = given().contentType("application/json")
