...
/**
 * Created by i82718 on 2/28/2018.
 */
public class TopTenDrugsTest extends AbstractDeveloperPageAction {
    ...
    static String memberQueryFileName = "topTenDrugsWidgetMemberQuery.sql";
    List<String> anaOpts = Arrays
            .asList(PEPM, PEPY, PMPM, PMPY, DRGS_MEMPER1000);
    ...
    public List<String> getAnaOpts() {
        return anaOpts;
    }

    @Test
    public void verifyAllAnaOptCombinations() {
        getAnaOpts().forEach(
                anaOptions -> verifyWidgetCallWithDifferentAnalyticOptions(
                        anaOptions));
    }

    public void verifyWidgetCallWithDifferentAnalyticOptions(
            String anaOptions) {
        String[][] blParam = { { "ABC" }, { "Blumfield IPA" }, {}, {}, {}, {} };
        JsonBuilder payLoad = new PayloadCreator()
                .topTenDrugsWidgetPayload(blParam, FULL_CYCLE, INCURRED_DATE,
